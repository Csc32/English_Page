...
export const BUTTON_STYLES = [
  {
    ...
    submit: {
      style:
        'text-gray-800 bg-white py-3 px-2 hover:bg-gray-600 hover:text-white transition ease-linear duration-300 focus:ring-4 focus:outline-none focus:ring-gray-500 font-medium rounded-lg text-sm px-4 py-2 text-center',
      name: 'Enviar Mensaje',
      type: 'submit',
    },
  },
